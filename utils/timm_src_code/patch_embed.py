...
if __name__ == "__main__":
    ...
    x_embedder = PatchEmbed(img_size=h, patch_size=patch_size, in_chans=c, embed_dim=embed_dim)
    out = x_embedder(x)
    print("shape of out", out.shape)

    print("")

    x_embedder = timm_PatchEmbed(img_size=h, patch_size=patch_size, in_chans=c, embed_dim=embed_dim)
    out = x_embedder(x)
    print("shape of out", out.shape)
